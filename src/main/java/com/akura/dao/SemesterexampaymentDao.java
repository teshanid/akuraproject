...
public interface SemesterexampaymentDao extends JpaRepository<Semesterexampayment, Integer> {


    @Query("SELECT s FROM Semesterexampayment s ORDER BY s.id DESC")
    Page<Semesterexampayment> findAll(Pageable of);
